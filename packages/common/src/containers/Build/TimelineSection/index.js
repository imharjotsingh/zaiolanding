...
import { Timeline } from '../../../data/Build/data';

import Illustration from '../../../assets/image/saas/illustration.png';
import Screen from '../../../assets/image/build/screen.png';
    ...
    <Box {...sectionWrapper} id="timeline_section">
      <Container>
        <Box {...sectionHeader}>
          ...
          <Heading
            {...sectionTitle}
            content="On a serious note! It's just simple steps"
          />
        </Box>
        <Box {...row}>
          <Box {...col} {...imageArea}>
            <Fade bottom>
              <Image {...imageTwo} src={Screen} alt="Screen" />
            </Fade>
          </Box>
          <Box {...col} {...textArea}>
            <TimelineWrapper>
        ...
        <Box {...buttonWrapper}>
          <Link href="#">
            <a>
              <Button {...button} title="CALL TO ACTION..." />
            </a>
          </Link>
        </Box>
      </Container>
